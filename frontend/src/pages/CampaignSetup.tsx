...
import type { CampaignProfile, RaceDirectory, RaceImportResult } from '../api/types'
    ...
    <div className="page">
      ...
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
        <div>
          ...
          <p className="page-subtitle">Your campaign profile personalizes all AI-generated talking points, actions, and analysis.</p>
        </div>
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'flex-start', marginBottom: '1rem' }}>
          <div>
            <div className="section-title" style={{ marginBottom: 4 }}>Race Setup</div>
            <p style={{ margin: 0, fontSize: '0.76rem', color: 'var(--text-muted)', lineHeight: 1.5, maxWidth: 560 }}>
              Directory covers FEC 2025-2026 federal filings (U.S. House &amp; Senate). State, local, and municipal races should use custom setup.
            </p>
          </div>
        ...
        {setupMode === 'directory' ? (
          ...
          <div style={{ padding: '0.75rem', borderRadius: 'var(--radius-sm)', background: 'var(--surface-2)', border: '1px solid var(--border)', fontSize: '0.78rem', color: 'var(--text-secondary)', lineHeight: 1.5 }}>
            Fill in the Candidate Information section below and save normally. Custom setup is for state, local, and municipal races not in the FEC directory.
          </div>
        )}
      </div>
      ...
      {/* Candidate Info */}
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        <div className="section-title" style={{ marginBottom: '1rem' }}>Candidate Information</div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <div>
            <div className="label" style={{ marginBottom: 4 }}>Candidate Name *</div>
            <input value={form.candidate_name} onChange={field('candidate_name')} placeholder="e.g. Maria Chen" />
          </div>
          <div>
            <div className="label" style={{ marginBottom: 4 }}>Party</div>
            <input value={form.party} onChange={field('party')} placeholder="e.g. Democrat" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="date" value={form.election_date} onChange={field('election_date')} />
          </div>
      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        {saved && <span style={{ fontSize: '0.8rem', color: 'var(--ok-light)' }}>✓ Saved — talking points and actions now use this profile</span>}
